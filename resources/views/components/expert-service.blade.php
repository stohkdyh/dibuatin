...
<div
    ...
    <div class="w-1/2 px-8 py-8 relative">
        <span
            class="h-[25rem] w-[25rem] bg-[#E67E22] rounded-full inline-block absolute opacity-40 blur-2xl -top-[50%] {{ $imagePosition === 'right' ? '-left-[40%] ' : '-right-[40%] ' }}"></span>
        <h2 class="text-3xl font-semibold mb-4 text-left">
    ...
    <!-- Bagian Gambar -->
    <div class="w-1/2">
        <img class="object-cover rounded-xl w-full" src={{ $image ?: '/images/bg-short-adds.jpeg' }}
