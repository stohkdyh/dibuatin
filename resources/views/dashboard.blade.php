...
=======
    ...
    <section class="py-12 bg-gray-100">
        <div
            ...
            <p class="text-gray-600 mb-8">
                ...
                tailored to captivate and connect.
            </p>
    ...
    <div class="flex w-full justify-between">
        <div
            ...
            <!-- Heading -->
            <h2 class="text-3xl mb-4">Voices of
    ...
    <footer class="mx-20">
        <div class="flex justify-end my-8">
            ...
            <input
                ...
                type="email">
            <button
                class="rounded-xl h-10 my-2 px-4 text-white text-sm"
                style="background-color: #FF7800">Subscribe</button>
        </div>
        <hr>
        <div
            class="flex justify-end text-gray-700 items-center my-8">
            <div class="w-full">
            ...
            <div
                class="grid grid-cols-3 mr-10 gap-28">
                <div
                    class="text-black text-nowrap ">
                    <p
                        class="text-gray-700 font-bold mb-3">
                        Information</p>
                    <p>Home</p>
                    <p>About Us</p>
                    <p>Services</p>
        ...
        <hr>
        <div
            class="flex justify-end py-8 text-xs">
